...
static const char*CFG_KEYS[]={"default_agent","claude_prefix","source","multi_default","worktrees_dir","tmux_conf","cat_a","m_agent","m_model","m_effort","m_tier","i_agent","i_effort",NULL};
...
static int cmd_prompt(int argc, char **argv) {
    ...
    if(!strcmp(sub,"show")) {
        ...
        fprintf(stderr,"\n— unified prompt · %zu bytes · active file:%s · files: a prompt · edit/web: a prompt edit|web\n",n,act);return 0;
    }
