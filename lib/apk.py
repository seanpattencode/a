...
def run():
    ...
    if proj:
        ...
        else:w(D+"/app/src/main/cpp/native.c",NC);w(D+"/app/src/main/cpp/launcher.c",LC);w(D+"/app/src/main/cpp/CMakeLists.txt",CML)
